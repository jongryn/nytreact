...
// Loads all article and set them to this.state.article
loadArticles = () => {
    API.getArticles()
        .then(res => 
...
render() {
    return(
                        ...
                        <div className="panel-body">
                            <form>
                                <div className="form-group">
                                    ...
                                    <input value={this.state.startYear} onChange={this.handleInputChange} name="startYear" placeholder="Start Year (required)"/>
                                    <h4>
                                        <strong>End Year</strong>
                                    </h4>
                                    <input value={this.state.endYear} onChange={this.handleInputChange} name="endYear" placeholder="End Year (required)"/>
                                </div>
                                <div className="pull-right">
                                <FormBtn disabled={!(this.state.topic && this.state.startYear && this.state.endYear)} onClick={this.handleAPISearch} className="btn btn-success"> Submit </FormBtn>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <List />
        <Panel article = {this.state.article} found={this.state.found} />
    </div>
